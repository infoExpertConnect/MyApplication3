...
public class allrounder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allrounder);
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
           ...
           public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                 ...
                 {
                     case 1:
                         ArrayAdapter<String> adapter1=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,kolkata);
                         spinner2.setAdapter(adapter1);
                         break;
                     case 2:
                         ArrayAdapter<String> adapter2=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,royal);
                         spinner2.setAdapter(adapter2);
                         break;
                     case 3:
                         ArrayAdapter<String> adapter3=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,chennai);
                         spinner2.setAdapter(adapter3);
                         break;
                     case 4:
                         ArrayAdapter<String> adapter4=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,punjab);
                         spinner2.setAdapter(adapter4);
                         break;
                     case 5:
                         ArrayAdapter<String> adapter5=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,rajasthan);
                         spinner2.setAdapter(adapter5);
                         break;
                     case 6:
                         ArrayAdapter<String> adapter6=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,delhi);
                         spinner2.setAdapter(adapter6);
                         break;
                     case 7:
                         ArrayAdapter<String> adapter7=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,mumbai);
                         spinner2.setAdapter(adapter7);
                         break;
                     case 8:
                         ArrayAdapter<String> adapter8=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,Deccan);
                         spinner2.setAdapter(adapter8);
                         break;
                     case 9:
                         ArrayAdapter<String> adapter9=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,kochi);
                         spinner2.setAdapter(adapter9);
                         break;
                     case 10:
                         ArrayAdapter<String> adapter10=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,pune_war);
                         spinner2.setAdapter(adapter10);
                         break;
                     case 11:
                         ArrayAdapter<String> adapter11=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,sunriser);
                         spinner2.setAdapter(adapter11);
                         break;
                     case 12:
                         ArrayAdapter<String> adapter12=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,pune);
                         spinner2.setAdapter(adapter12);
                         break;
                     case 13:
                         ArrayAdapter<String> adapter13=new ArrayAdapter<String>(allrounder.this,android.R.layout.simple_spinner_dropdown_item,gujarat);
